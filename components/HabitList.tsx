...
export const HabitList: React.FC<HabitListProps> = ({
  ...
  const categories: (string | HabitCategory)[] = ['الكل', 'صلاة', 'قرآن', 'أذكار'];
    ...
    <div className="bg-white rounded-2xl border border-gray-200/80 p-5 sm:p-6 shadow-xs">
      ...
      <div className="mt-5 pt-4 border-t border-gray-100">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-dashed border-gray-300 text-sm font-medium text-gray-600 hover:text-emerald-700 hover:border-emerald-400 hover:bg-emerald-50/40 transition-all group"
        >
